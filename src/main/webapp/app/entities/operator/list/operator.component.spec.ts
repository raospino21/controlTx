...
describe('Operator Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'operator', component: OperatorComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to operatorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOperatorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOperatorIdentifier).toHaveBeenCalledWith(entity);
